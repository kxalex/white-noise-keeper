...
class AudioLoadGuard:
    ...
    def load(
        ...
        try:
            ...
            if restore_after_load and self._restore_best_effort():
                self._clear_pending()
            raise
